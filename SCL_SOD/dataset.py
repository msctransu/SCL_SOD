...
class ImageData(data.Dataset):
    def __init__(self, dataset_list, data_root, transform, mode, img_size=None, scale_size=None, t_transform=None, label_14_transform=None, label_28_transform=None, label_56_transform=None, label_112_transform=None, argumentation = None):
    ...
    def __getitem__(self, item):
        ...
        if self.mode == 'train':
            ...
            arg_image = loader.TwoCropsTransform(transforms.Compose(self.argumentation))(image)

            return new_img, label_224, label_14, label_28, label_56, label_112, \
                   contour_224, contour_14, contour_28, contour_56, contour_112, arg_image
        else:
...
def get_loader(dataset_list, data_root, img_size, mode='train'):
    ...
    if mode == 'train':
        dataset = ImageData(dataset_list, data_root, transform, mode, img_size, scale_size, t_transform, label_14_transform, label_28_transform, label_56_transform, label_112_transform, augmentation)
    else:
